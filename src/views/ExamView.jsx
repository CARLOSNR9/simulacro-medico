        ...
        <main className="max-w-5xl mx-auto px-4 py-8">
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    className={`bg-white rounded-3xl shadow-sm border p-6 relative transition-colors ${isMarked ? "border-amber-300" : "border-slate-200"
                        }`}
                >
                    {/* stem */}
                        ...
                        {question.options.map((opt, idx) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left border rounded-xl px-4 py-3 transition-all ${selected
                    ...
                    <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-100">
                        ...
                        >
                            {current === total - 1 ? "Finalizar Examen" : "Siguiente →"}
                        </button>
                    </div>
                </motion.div>
            </AnimatePresence>
